...
class Note(object):
    ...
    def __str__(self):
        return 'Name: ' + self.name + ' Phone number: ' + self.phone_number + ' Birth date: ' + self.birth_date

    def __repr__(self):
        return '{"name":"' + self.name + '","phone_number":"' + self.phone_number + '","birth_date":"' + self.birth_date + '"}'
